...
def root_emulator():
    ...
    if _os in ('Darwin', 'Linux'):
        cmd = f'cd {os.getcwd()}/modules/rootAVD-master && bash "rootAVD.sh {pimage}/ramdisk.img"'
    elif _os == 'Windows':
        cmd = f'cd {os.getcwd()}/modules/rootAVD-master && cmd /c "rootAVD.bat {pimage}/ramdisk.img"'
